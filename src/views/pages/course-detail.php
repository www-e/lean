            ...
            <ul class="divide-y divide-base-300">
                ...
                <li class="flex items-center justify-between p-4 hover:bg-base-100 dark:hover:bg-gray-700">
                    <div class="flex items-center">
                        <!-- Lock Icon -->
                        <svg class="w-5 h-5 text-secondary mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 2a3 3 0 00-3 3v2H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2h-2V5a3 3 0 00-3-3zm-1 3a1 1 0 012 0v2H9V5z" clip-rule="evenodd"></path></svg>
